...
class TotalStatistics extends React.Component {
    ...
    render() {
        return <div className = 'g-wrapper' > {
            ...
            < div className = "conts" >
            < div className = "title" >昨日积分< /div> < div className = "num" >{this.state.data.ishave == 1 ? this.state.data.zrfwl : "--"} < /div> < /div>
           < /div>
            < div className = "statistics" >
            < div className = "conts" >
            < div className = "title" >总积分 < /div> < div className = "num" >{this.state.data.ishave == 2 ? this.state.data.zfwl : "--"} < /div> < /div>          
            < /div>
            < /div>}
